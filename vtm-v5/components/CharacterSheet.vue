...
import ClanSelector from './ClanSelector.vue'
import AttributeSkillGrid from './AttributeSkillGrid.vue'
import DisciplinePanel from './DisciplinePanel.vue'
import MeritFlawPicker from './MeritFlawPicker.vue'
import VampireStatusBar from './VampireStatusBar.vue'
    ...
    <div v-if="showExport" class="modal-overlay" @click.self="showExport = false">
      <div class="modal">
        ...
        <div class="modal-actions">
          <button class="action-btn" type="button" @click="navigator.clipboard?.writeText(exportData)">
            Копировать
          </button>
